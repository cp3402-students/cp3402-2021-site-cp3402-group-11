...
var FrontendBlock = function (_a) {
    ...
    var showBillingFields = (0, hooks_1.useCheckoutAddress)().showBillingFields;
    ...
    return (<cart_checkout_1.FormStep id="billing-fields" disabled={checkoutIsProcessing} className={(0, classnames_1.default)('wc-block-checkout__billing-fields', className)} title={title} description={description} showStepNumber={showStepNumber}>
			<block_1.default requireCompanyField={requireCompanyField} showApartmentField={showApartmentField} showCompanyField={showCompanyField} showPhoneField={showPhoneField} requirePhoneField={requirePhoneField}/>
			{children}
