...
var Edit = function (_a) {
    ...
    return (<form_step_1.FormStepBlock setAttributes={setAttributes} attributes={attributes} className={(0, classnames_1.default)('wc-block-checkout__billing-fields', attributes === null || attributes === void 0 ? void 0 : attributes.className)}>
			<Controls />
			...
			<form_step_1.AdditionalFields block={blocks_checkout_1.innerBlockAreas.BILLING_ADDRESS}/>
